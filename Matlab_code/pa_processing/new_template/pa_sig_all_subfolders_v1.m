%PA sig_all_subfolders
%
%Analyses signal stats inside a gated time frame
%for the photoacoustic signals over time
%
%Outputs of the PA amplitude (in V) and integrated sum of sqaure of signal
%over time for each gate is given 
%
%Written by David Harris-Birtill
%modified from Ir_cam_analysis_all_subfolders (also written by DHB)
%First created on 24/01/2014
%
%
