...
processed_results_folder = 'I:\Data\PA_exp_with_heating_GNRS_5th_dec_13\Processed_all_results\ROI_14_Gate_14\';
...
while repeat_all_clicks ~=1
    ...
    hold on
    plot(last_pa_signal.data(:,1),last_pa_signal.data(:,2),'b');
    hold on, plot([first_pa_signal.data(first_time_gate_index,1) first_pa_signal.data(first_time_gate_index,1)],[min(first_pa_signal.data(:,2)), max(first_pa_signal.data(:,2))], 'k--');
    hold on, plot([first_pa_signal.data(last_time_gate_index,1) first_pa_signal.data(last_time_gate_index,1)],[min(first_pa_signal.data(:,2)), max(first_pa_signal.data(:,2))], 'k--');
