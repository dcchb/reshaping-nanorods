...
%get data paths:
initial_folder = pwd;
pathname = 'E:\Data\PA_exp_with_heating_GNRS_5th_dec_13\spectra\raw_data\CTAB_GNR_Spectra_before_and_after_laser_with_PA_monitoring';
...
save_pathname = 'E:\Data\PA_exp_with_heating_GNRS_5th_dec_13\spectra\for_paper\spectra_normalised_to_TSPR_peak';
...
norm_absorbance(:,i) = sample_spectrum.data(:,2)/max(sample_spectrum.data((751-230):(751-130),2));
i=i+1;
...
laser_line_h = line([808 808],[0 max(norm_absorbance(:))]);
...
saveas(gcf,[save_pathname,'All_spectra_with_laser_line_normalised'],'png');