...
for file_num = 1:num_files
    ...
    for threshold_value = thresh_start:thresh_end
        ...
        if obj_i > most_nanorods_detected
            ...
            %also record the images for the 'best' threshold
            %best_loaded_image = loaded_image;
            best_thresholded_image_threshold = thresholded_image_threshold;
            best_test_grad_mag = test_grad_mag;
            best_test_edges5 = test_edges5;
            best_watershed_test2 = watershed_test2;
            best_num_objects = num_objects;
            best_good_obj_number = good_obj_number;
            best_obj_i = obj_i;
        ...
        clear thresholded_image_threshold test_grad_mag test_edges5 watershed_test2 num_objects obj_i
    end
    ...
    %same for images:
    %loaded_image = best_loaded_image;
    thresholded_image_threshold = best_thresholded_image_threshold;
    test_grad_mag = best_test_grad_mag;
    test_edges5 = best_test_edges5;
    watershed_test2 = best_watershed_test2;
    num_objects = best_num_objects;
    good_obj_number = best_good_obj_number;
    obj_i = best_obj_i;
